        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="md:hidden">
            <button
              ...
              className="text-white p-2 hover:bg-slate-800 rounded-lg transition-colors duration-300"
          ...
          <div className="md:hidden py-6 border-t border-slate-800">
            <div className="flex flex-col gap-4">
              ...
              <a
                href="#contact"
                onClick={() => setMobileMenuOpen(false)}
                className="bg-violet-600 hover:bg-violet-700 text-white font-semibold rounded-xl px-6 py-3 transition-all duration-300 shadow-sm hover:shadow-md text-center mt-2"
              >
                Get Started
              </a>
            </div>
